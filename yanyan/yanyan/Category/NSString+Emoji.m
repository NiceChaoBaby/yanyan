...
{
    int  unicodeIntValue = (int)strtoul([self UTF8String],0,16);
...
- (NSString *)emojiStrToUStr
{
    ...
    {
        hexstr = [NSString stringWithFormat:@"%1X",[self characterAtIndex:0]];
        
    }
    int count = 8 - (int)hexstr.length;
    for(int i = 0;i < count;i ++)
    {
        hexstr = [NSString stringWithFormat:@"0%@",hexstr];
    }
    hexstr = [NSString stringWithFormat:@"\\U%@",hexstr];
    return hexstr;
}
@end
