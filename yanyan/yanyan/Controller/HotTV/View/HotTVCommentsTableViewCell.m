...
#import "HotTVCommentsTableViewCell.h"
#import "HotTvCommentsCollectionViewCell.h"
@implementation HotTVCommentsTableViewCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.contentView sd_addSubviews:@[self.m_userPhoto,self.m_userName,self.m_time,self.m_commentLabel,self.m_collectionView,self.m_downView]];
