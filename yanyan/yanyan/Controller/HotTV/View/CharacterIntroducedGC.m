...
@implementation CharacterIntroducedGC
...
*/
+(CharacterIntroducedGC *)shareInstance
{
    static id sharedInstance=nil;
    if(!sharedInstance)
    {
        
        sharedInstance = [[CharacterIntroducedGC alloc] initWithFrame:CGRectMake(0,0, LCDW, LCDH+20)];
...
-(void)addWaitingFigureView:(RoleIntroduceInfo*)model
{
    ...
    m_UserName.font = [UIFont systemFontOfSize:22.0f];
    m_UserName.textColor = RGBChatTextColor;
    
    //角色英文名
    UILabel * m_EnameLabel = [UILabel new];
    m_EnameLabel.textAlignment = NSTextAlignmentLeft;
    //这里是半粗体 [UIFont fontWithName:@"PingFangSC-Semibold" size:22.0f]  PingFangSC-Medium
    m_EnameLabel.font = [UIFont systemFontOfSize:18.0f];
    m_EnameLabel.textColor = RGBChatTextColor;
    
    //国家
    UILabel * m_countriesLabel = [UILabel new];
    m_countriesLabel.textAlignment = NSTextAlignmentLeft;
    //这里是半粗体 [UIFont fontWithName:@"PingFangSC-Semibold" size:22.0f]  PingFangSC-Medium
    m_countriesLabel.font = [UIFont systemFontOfSize:18.0f];
    m_countriesLabel.textColor = RGBChatTextColor;
    
    //出生年月
    UILabel * m_timeBirthday = [UILabel new];
    m_timeBirthday.textAlignment = NSTextAlignmentLeft;
    //这里是半粗体 [UIFont fontWithName:@"PingFangSC-Semibold" size:22.0f]  PingFangSC-Medium
    m_timeBirthday.font = [UIFont systemFontOfSize:18.0f];
    m_timeBirthday.textColor = RGBChatTextColor;
    
    
    //textView
    UITextView * m_textView = [UITextView new];
    m_textView.font = [UIFont systemFontOfSize:16.0f];
...
//    [DTools getAvaterCorner:m_imageView];
    ...
    m_imageView.layer.cornerRadius = 10;
    m_imageView.layer.masksToBounds = YES;
    //    [DTools getAvaterCorner:m_userPhotoView];
    //角色名
    m_UserName.text = model.m_rname;
    [m_UserName sizeToFit];
    //英文名
    m_EnameLabel.text = @"laidigege";
    [m_EnameLabel sizeToFit];
    //国际地区
    m_countriesLabel.text = @"美国华盛顿";
    [m_countriesLabel sizeToFit];
    //生日
    m_timeBirthday.text = @"1990-01-01";
    [m_timeBirthday sizeToFit];
    //角色介绍
   ...
   //算出来的高度只是文字高度 控件的内间距没有  所以加20的高度 不让字体显示不全
    ...
    [m_imageView sd_addSubviews:@[m_userPhotoView,m_UserName,m_EnameLabel,m_countriesLabel,m_timeBirthday,m_textView]];
    ...
    .topSpaceToView(m_imageView, 25)
    .heightIs(20);
    
    //角色英文名
    m_EnameLabel.sd_layout
    .leftSpaceToView(m_userPhotoView, 23)
    .rightSpaceToView(m_imageView, 18)
    .topSpaceToView(m_UserName, 5)
    .heightIs(20);
    
    //国家地区
    m_countriesLabel.sd_layout
    .leftSpaceToView(m_userPhotoView, 23)
    .rightSpaceToView(m_imageView,18)
    .topSpaceToView(m_EnameLabel, 5)
    .heightIs(20);
    
    //出生年月
    m_timeBirthday.sd_layout
    .leftSpaceToView(m_userPhotoView, 23)
    .rightSpaceToView(m_imageView,18)
    .topSpaceToView(m_countriesLabel, 5)
    .heightIs(20);
    ...
    .rightSpaceToView(m_imageView,18)
    .topSpaceToView(m_timeBirthday,20)
    .heightIs(H);
...
//    .heightIs(60);
     ...
     [m_imageView setupAutoHeightWithBottomViewsArray:@[m_textView] bottomMargin:20];
...
//    optionsattributes:@{NSFontAttributeName:[UIFontsystemFontOfSize:fontSize]}
    ...
    NSAttributedString *string = [[NSAttributedString alloc]initWithString:value attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:fontSize], NSParagraphStyleAttributeName:style}];
