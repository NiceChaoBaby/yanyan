...
@protocol EMChatToolbarDelegateG;
@interface EaseChatToolbarG : UIView

//@property (weak, nonatomic) id<EMChatToolbarDelegateG> delegate;
//
...
// *  录音的附加页面
// */
//@property (strong, nonatomic) EaseRecordHandleView *recordHandleView;
//
...
//@end
//
//@protocol EMChatToolbarDelegateG <NSObject>
//
//@optional
//
///**
...
// *  高度变到toHeight
// */
//- (void)chatToolbarDidChangeFrameToHeight:(CGFloat)toHeight textViewH:(CGFloat)high  text:(NSString *)text;
//
///**
// 按了分享按钮
// */
