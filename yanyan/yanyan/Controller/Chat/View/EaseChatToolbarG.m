...
@interface EaseChatToolbarG()
//<UITextViewDelegate, EMFaceDelegate>
//
...
//@end
//
//@implementation EaseChatToolbarG
//
...
//        
////        [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(aa:) name:UIKeyboardDidShowNotification object:nil];
////         [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(bb:) name:UIKeyboardWillHideNotification object:nil];
//        
//        [self _setupSubviews];
//    }
//    return self;
...
//    //这里控制整个背景颜色
//    _toolbarBackgroundImageView.backgroundColor = RGBBgColor;
//    [_toolbarView addSubview:_toolbarBackgroundImageView];
//    
//    UIImageView * image = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, LCDW, 1)];
//    image.backgroundColor = RGBLineColor;
...
//    [styleChangeButton setImage:[UIImage imageNamed:@"news_share"] forState:UIControlStateNormal];
//    [styleChangeButton setImage:[UIImage imageNamed:@"news_share"] forState:UIControlStateSelected];
//    [styleChangeButton addTarget:self action:@selector(styleButtonAction:) forControlEvents:UIControlEventTouchUpInside];
//    styleChangeButton.backgroundColor = RGBBgColor;
...
//    self.recordHandleView.m_recordButton.backgroundColor = [UIColor clearColor];
...
//    [self.faceButton setImage:[UIImage imageNamed:@"news_emoticons"] forState:UIControlStateNormal];
//    [self.faceButton setImage:[UIImage imageNamed:@"news_keyboard"] forState:UIControlStateHighlighted];
//    [self.faceButton setImage:[UIImage imageNamed:@"news_keyboard"] forState:UIControlStateSelected];
...
//    self.faceButton.backgroundColor = RGBBgColor;
////    //更多
...
//        [(EaseFaceView *)_faceView setEmotionManagers:@[manager]];
...
//#pragma mark - setter
//
//- (void)setDelegate:(id<EMChatToolbarDelegateG>)delegate
//{
//    _delegate = delegate;
...
//    inputFrame.size.width += value;
//    self.inputTextView.frame = inputFrame;
//    DLog(@"------------ %f -----------",inputFrame.size.height);
//    
//    
//    self.textViewH = inputFrame.size.height;
//    
//    //    CGRect recordFrame = self.recordButton.frame;
//    //    recordFrame.origin.x = inputFrame.origin.x;
//    //    recordFrame.size.width = inputFrame.size.width;
...
//        
//        if (_delegate && [_delegate respondsToSelector:@selector(chatToolbarDidChangeFrameToHeight:textViewH:text:)]) {
//            [_delegate chatToolbarDidChangeFrameToHeight:self.frame.size.height textViewH:self.textViewH text:self.inputTextView.text];
//        }
//    }
//}
//
...
//    
//    if (_delegate && [_delegate respondsToSelector:@selector(chatToolbarDidChangeFrameToHeight:textViewH:text:)]) {
//        [_delegate chatToolbarDidChangeFrameToHeight:toHeight textViewH:self.textViewH text:self.inputTextView.text];
//    }
//}
//
...
//    
//    DLog(@"---------- %f %f %f ------------",endFrame.size.height,beginFrame.size.height,duration);
//    
//    
//    
//    
...
//{
//    
//    if ([self.delegate respondsToSelector:@selector(sharView)]) {
//        [self.delegate sharView];
//    }
...
//
//////键盘开启
////-(void)aa:(NSNotification *)notification
////{
////    DLog(@".............");
////    
////}
...
////{
////    
////    if ([self.delegate respondsToSelector:@selector(closeKeyboardText:)]) {
////        [self.delegate closeKeyboardText:self.inputTextView.text];
////    }
////    
////    DLog(@"+++++++++++++");
////    
