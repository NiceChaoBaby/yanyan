...
//感兴趣按钮
@property (nonatomic) BOOL m_isSelect;
//话题聊天室创建人id
@property (nonatomic,strong) NSString *m_topicOwnerId;

@property(nonatomic,strong)NSMutableArray  *m_adminIdArr;//已加入群信息
//xiong 2016.4.7 距离
//================
@property (strong, nonatomic) NSString *m_distanceText;
@property (strong, nonatomic) NSIndexPath *m_indexPath;
/**
 *  定位信息
 */
@property (strong, nonatomic) NSString *m_locationText;
/**
 *  定位图标
 */
@property (strong, nonatomic) UIImage *m_locationImage;
