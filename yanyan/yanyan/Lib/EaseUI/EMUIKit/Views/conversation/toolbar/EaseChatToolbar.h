...
@property (nonatomic, readonly) EMConversationType chatBarType;
 ...
 *  话题聊天禁言背景视图
 */
@property(nonatomic,strong) UIView *m_topicForbitView;
/**
 *  话题聊天室禁言标题
 */
...
@property(nonatomic,assign) BOOL m_isChatRoom;
