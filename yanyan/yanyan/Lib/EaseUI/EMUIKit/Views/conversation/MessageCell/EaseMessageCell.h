...
#define kEMMessageImageSizeWidth 155
#define kEMMessageImageSizeHeight 155
...
@property (nonatomic) NSLayoutConstraint *bubbleWithBubbleBottomConstraint;
...
//xiong 2016.4.7 距离
//=========
@property (strong, nonatomic) UILabel *m_distancelab;
/**
 *  定位信息
 */
@property (strong, nonatomic) UILabel *m_locationlab;
/**
 *  定位图标
 */
@property (strong, nonatomic) UIImageView *m_locationImageView;
@property (strong, nonatomic) UIButton *m_textButton;

/**
 *  性别
 */
@property (strong, nonatomic) UIImageView *m_sexImageView;
//=========
...
@property (strong, nonatomic) NSIndexPath *m_indexPath;
/*!
 @property
 @brief 状态尺寸
 */
...
/*!
 ...
 @brief 消息字体
 */
@property (nonatomic) UIFont *messageTextFont UI_APPEARANCE_SELECTOR; //default [UIFont systemFontOfSize:16];
...
- (void)messageCellUrl:(NSString *)url;
