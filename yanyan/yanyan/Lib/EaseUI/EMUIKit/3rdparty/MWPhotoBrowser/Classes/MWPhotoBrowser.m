...
- (void)viewDidLoad {
    ...
    //添加长按保存图片功能
    UILongPressGestureRecognizer * longGesture = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(SavePicture:)];
 ...
 *  保存图片
 */
-(void)SavePicture:(UILongPressGestureRecognizer*)gest
{
...
- (void)performLayout {
    ...
    // Toolbar visibility
  //    [_toolbar setItems:items];//隐藏底部按钮
