...
+ (NSArray *)allEmoticons {
    ...
    NSMutableArray * localAry = [[NSMutableArray alloc] initWithObjects:
                                 [EaseEmoji emojiWithCode2:@"[):]"],
                                 [EaseEmoji emojiWithCode2:@"[:D]"],
                                 [EaseEmoji emojiWithCode2:@"[;)]"],
                                 [EaseEmoji emojiWithCode2:@"[:-o]"],
                                 [EaseEmoji emojiWithCode2:@"[:p]"],
                                 [EaseEmoji emojiWithCode2:@"[(H)]"],
                                 [EaseEmoji emojiWithCode2:@"[:@]"],
                                 [EaseEmoji emojiWithCode2:@"[:s]"],
                                 [EaseEmoji emojiWithCode2:@"[:$]"],
                                 [EaseEmoji emojiWithCode2:@"[:(]"],
                                 [EaseEmoji emojiWithCode2:@"[:'(]"],
                                 [EaseEmoji emojiWithCode2:@"[:|]"],
                                 [EaseEmoji emojiWithCode2:@"[(a)]"],
                                 [EaseEmoji emojiWithCode2:@"[8o|]"],
                                 [EaseEmoji emojiWithCode2:@"[8-|]"],
                                 [EaseEmoji emojiWithCode2:@"[+o(]"],
                                 [EaseEmoji emojiWithCode2:@"[<o)]"],
                                 [EaseEmoji emojiWithCode2:@"[|-)]"],
                                 [EaseEmoji emojiWithCode2:@"[*-)]"],
                                 ...
                                 [EaseEmoji emojiWithCode2:@"[8-)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/|)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/u)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/S)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/*)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/#)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/R)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/{)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/})]"],
                                 [EaseEmoji emojiWithCode2:@"[(/k)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/F)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/W)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/D)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/SH)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/88)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/JY)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/BX)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/AW)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/KL)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/QF)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/:X)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/FW)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/ZT)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/pen)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/KULOU)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/GL)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/JS)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/qs)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/BP)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/qiang)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/ruo)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/hd)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/shl)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/gy)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/qidao)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/yao)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/feizao)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/yl)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/ty)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/ws)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/xin)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/xs)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/mg)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/lw)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/ch)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/aini)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/dabian)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/kf)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/yinyue)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/dg)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/huashu)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/dao)]"],
                                 [EaseEmoji emojiWithCode2:@"[(/5mao)]"],
                                 nil];
